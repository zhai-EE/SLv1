...
# 这里照搬了torchvision里面的resnet实现 https://github.com/pytorch/vision/blob/main/torchvision/models/resnet.py
# 但是第一个卷积层的大小从7*7改为了3*3,padding也从3改为了1
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        width = int(planes * (base_width / 64.)) * groups  # 正常情况下width就等于输出特征数planes
